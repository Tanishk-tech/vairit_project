    ...
    return (
        <div className="bg-grey pl-[12%] pr-[3%] py-[2%] flex max-sm:flex max-sm:text-center max-sm:items-center" id="s10">
            ...
            <div className="w-[50%] flex justify-end max-sm:hidden">
                <p className="pr-10"><span className="curser-pointer hover:text-red hover:underline" onClick={termPage}>Terms & Conditions</span></p>
                <p className=""><span className="curser-pointer hover:text-red hover:underline" onClick={privacyPage}>Privacy Policy</span></p>
            </div>
