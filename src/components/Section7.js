    ...
    return (
        <div className="flex  py-[6%]">
            ...
            <div className="flex flex-col justify-center w-[50%]">
                ...
                <span className="bg-red w-fit text-white text-xs font-bold uppercase text-center  px-10  py-4 hover:bg-yellow hover:text-red rounded-xl cursor-pointer ">view more</span>
            </div>
        </div>
    )
}
