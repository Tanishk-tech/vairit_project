...
const Section7 = () => {
    ...
    return (
        <div className="flex  py-[6%] max-sm:px-4 max-sm:flex-col" id="s7">
            <div className="w-[50%] max-sm:w-[100%]" data-aos="fade-right">
                <img src="./images/book.png" alt="book"/>
            </div>
            <div className="flex flex-col justify-center w-[50%] max-sm:w-[100%] max-sm:items-center max-sm:text-center max-sm:pt-10" data-aos="fade-left">
