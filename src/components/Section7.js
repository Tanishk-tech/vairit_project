...
const Section7 = () => {
    ...
    return (
        <div className="flex  p-[6%] max-sm:px-4 max-sm:flex-col" id="s7">
            ...
            <div className="flex flex-col justify-center w-[30%]  max-sm:w-[100%] max-sm:items-center max-sm:text-center max-sm:pt-10" >
                ...
                <button className="bg-red w-fit text-white text-base font-bold capitalize text-center  px-8  py-4 hover:bg-yellow hover:text-red rounded-xl cursor-pointer max-sm:px-4 max-sm:py-2 max-sm:text-sm" onClick={handleChange} >view more</button>
            </div>
        </div>
    )
}
