...
const Section6 = () =>{
    ...
    return (
        <div className="flex flex-col items-center bg-red px-[12%] py-[6%] relative max-sm:px-4 max-sm:py-[15%] " id="s6">
            ...
            <h2 className="text-3xl capitalize leading-none text-white pb-4 max-sm:text-4xl max-sm:text-center" data-aos="fade-right">YEARS OF LEGACY</h2>
            <p className="text-white text-center text-xl max-sm:text-xl" data-aos="fade-right">SRI RAGHUNATH JI OVERSEAS has been a pioneering figure in the Hing import business since its inception. For more than 50 years, we have been a reliable source of premium-quality Hing, serving a clientele which stretches PAN INDIA. Our unwavering commitment to excellence has made us a trusted name In the industry.</p>
        </div>
    )
}
